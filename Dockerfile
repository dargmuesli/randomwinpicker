# Base image
FROM node:buster@sha256:ecf541bdc36cfe8248211f596b0e8ba1dff4259805984aa460e34fd95fa39233 AS stage_build
...
# Base image
FROM php:7.4-fpm-alpine@sha256:92bfe1db706ec78f00a1dcfb7bf4957ef64ef2f3c1bb60b8876b482498f2a507 AS development
