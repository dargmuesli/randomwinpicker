<?php
    ...
    $skeletonContent = '
        <body class="parallax">
            <noscript>
                <iframe sandbox="" src="https://www.googletagmanager.com/ns.html?id=GTM-T32JLW" height="0" width="0"></iframe>
            </noscript>
            <script src="/resources/dargmuesli/google-tagmanager/tagmanager.js"></script>
